<?php
    ...
    if($row !== NULL){
        $sql = "UPDATE `roles` SET `name`='$data->roleName', userManage='$data->userManage', roleManage='$data->roleManage', catManage='$data->catManage', unionManage='$data->unionManage', dataManage='$data->dataManage',
        custManage='$data->custManage', taskManage='$data->taskManage', contestManage='$data->contestManage', postManage='$data->postManage' WHERE `name`='$data->cookieName'";
    // echo "-2-".$sql;
    } else {
