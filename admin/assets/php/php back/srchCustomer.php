<?php
    ...
    $sql_query = "select * from profile_table where (name LIKE '%$srchKey%' OR role LIKE '%$srchKey%' OR skils LIKE '%$srchKey%' OR profile_table.union LIKE '%$srchKey%' OR location LIKE '%$srchKey%' OR sublocation LIKE '%$srchKey%') AND isActive=1 order by doj desc;";
